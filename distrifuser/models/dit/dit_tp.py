...
from distrifuser.models.base_model import BaseModule, BaseModel

from distrifuser.models.base_model import BaseModel
from distrifuser.modules.transformer_2d import DistriTransformer2DModel
from distrifuser.modules.tensor_parallel import AttnTP, Conv2dTP, FFNTP
                ...
                for subname, submodule in module.named_children():
                    if isinstance(submodule, nn.Conv2d):
                        ...
                        if (
                            ...
                            continue
                        wrapped_submodule = Conv2dTP(submodule, distri_config)
                        setattr(module, subname, wrapped_submodule)
                        pass
                    elif isinstance(submodule, FeedForward):
                        wrapped_submodule = FFNTP(submodule, distri_config)
                        setattr(module, subname, wrapped_submodule)
                        pass
                    elif isinstance(submodule, Attention):
                        if subname == "attn1":  # self attention
                            wrapped_submodule = AttnTP(
